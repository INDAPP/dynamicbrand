...
public class PrincipleViewAdapter extends RecyclerView.Adapter<PrincipleViewAdapter.ViewHolder> {
    ...
    public PrincipleViewAdapter(List<Object> items, PrincipleFragment.OnPrincipleFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                    ...
                    mListener.onPrincipleFragmentInteraction(holder.mItem);
                }
            }
        });
    }
